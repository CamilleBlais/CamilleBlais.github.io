...
function Cloud() {
  ...
  this.xspeed = random(0.02,0.05);
    ...
    this.show = function() {
	  ...
	  rect(this.x+this.len/9,this.y-this.high/3,this.len/2,this.high,this.high/2);
	  rect(this.x+this.len/1.2,this.y-this.high/3,this.len/2,this.high,this.high/2);
    }
